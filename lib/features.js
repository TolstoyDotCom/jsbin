...
var flags = {
  ...
  // made overrideable with a config setting. Was: live June 16, 2014-05-27
  vanity: function (req) {
    var shareVanityURLs = undefsafe( config, 'features.shareVanityURLs' );

    if ( shareVanityURLs == 'always' ) {
      return true;
    }
    else if ( shareVanityURLs == 'never' ) {
      return false;
    }
